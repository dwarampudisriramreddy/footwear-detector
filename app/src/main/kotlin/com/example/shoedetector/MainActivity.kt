...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var footWearDetector: FootWearDetector
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        footWearDetector = FootWearDetector(this)
            ...
            val imageAnalyzer = ImageAnalysis.Builder()
                ...
                .also {
                    it.setAnalyzer(cameraExecutor) { imageProxy ->
                        ...
                        if (bitmap != null) {
                            val detections = footWearDetector.detect(bitmap)
                            runOnUiThread {
                                updateUI(detections)
                            }
                        } else {
    ...
    private fun updateUI(detections: List<FootWearDetector.Detection>) {
        viewBinding.overlayView.setDetections(detections)
        if (detections.isEmpty()) {
            viewBinding.tvResults.text = "No foot wear detected"
        } else {
    ...
    override fun onDestroy() {
        ...
        footWearDetector.close()
    }

    companion object {
        private const val TAG = "FootWearDetector"
    }
}
