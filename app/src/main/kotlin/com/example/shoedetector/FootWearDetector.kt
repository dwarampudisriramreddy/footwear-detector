...
class FootWearDetector(private val context: Context) {
    ...
    private val labels = listOf(
        "soccer", "boots", "flip_flops", "loafers", "sandals", "sneakers"
    )
    ...
    init {
        val modelBytes = context.assets.open("foot wear.onnx").readBytes()
    ...
    private fun postProcess(
        ...
        Log.d("FootWearDetector", "Detections: ${detections.size}, max score: $highestScoreFound")
